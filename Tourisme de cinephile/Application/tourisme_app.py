...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.s_title.setGeometry(QtCore.QRect(330, -30, 311, 91))
        font = QtGui.QFont()
        font.setPointSize(33)
        font.setBold(True)
        font.setItalic(True)
        ...
        self.s_arrdt.setGeometry(QtCore.QRect(570, 40, 131, 31))
        ...
        self.box_wifi.setGeometry(QtCore.QRect(410, 40, 61, 31))
        self.box_wifi.setObjectName(_fromUtf8("box_wifi"))
        self.film_all = QtGui.QGroupBox(self.research)
        self.film_all.setGeometry(QtCore.QRect(160, 110, 561, 111))
        ...
        self.check_arrdt.setGeometry(QtCore.QRect(540, 40, 102, 31))
        ...
        self.lattitude_input.setGeometry(QtCore.QRect(300, 80, 161, 31))
        self.lattitude_input.setObjectName(_fromUtf8("lattitude_input"))
        self.longitude_input = QtGui.QLineEdit(self.research)
        self.longitude_input.setGeometry(QtCore.QRect(540, 80, 161, 31))
        self.longitude_input.setObjectName(_fromUtf8("longitude_input"))
        self.lab_lattitude = QtGui.QLabel(self.research)
        self.lab_lattitude.setGeometry(QtCore.QRect(230, 80, 61, 31))
        self.lab_lattitude.setObjectName(_fromUtf8("lab_lattitude"))
        self.lab_longitude = QtGui.QLabel(self.research)
        self.lab_longitude.setGeometry(QtCore.QRect(470, 80, 61, 31))
        self.lab_longitude.setObjectName(_fromUtf8("lab_longitude"))
        ...
        self.lab_lattitude.raise_()
        self.lab_longitude.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lab_lattitude.setText(_translate("MainWindow", "Lattitude", None))
        self.lab_longitude.setText(_translate("MainWindow", "Longitude", None))
